...
RUN apt-get update &&  apt-get install vim curl wget unzip tmux libc6-i386 lib32stdc++6 lib32gcc1 lib32ncurses5 lib32z1 build-essential software-properties-common python-software-properties -y
